...
const Page = () => {
	...
	return (
		<div className="bg-gray-100 h-full  w-full flex-col flex md:flex-row items-center justify-center ps-1 sm:ps-2">
			<div className="w-full h-full md:w-[280px] lg:w-[300px] md:border-r md:border-gray-300 md:shadow-[3px_0_4px_-1px_rgba(0,0,0,0.1)] shadow-gray-200 px-1 sm:px-1 py-2 sm:py-3 ">
				<button
					onClick={() => router.back()}
