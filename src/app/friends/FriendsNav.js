...
const FriendsNav = () => {
	...
	return (
		<nav className="w-full md:w-[210px] lg:w-[280px] md:h-full md:border-r md:border-gray-300 md:shadow-[3px_0_4px_-1px_rgba(0,0,0,0.1)] shadow-gray-200 px-1 sm:px-2 py-2">
